...
import com.alpidi.exception.RequestTimeoutException;
...
public class Shipment extends APIResource{
	...
	public static RateCollection getShippingRates(String id, String apiKey)
			throws AuthenticationException, InvalidRequestException,
			APIConnectionException, APIException {
		return request(RequestMethod.GET, instanceURL(Shipment.class, id)+ "/rates/", null, RateCollection.class, apiKey);
	}
	...
	public static RateCollection getShippingRates(String id,
		...
		return request(RequestMethod.GET, instanceURL(Shipment.class, id) + "/rates/" + currency_code, null, RateCollection.class, apiKey);
	}
